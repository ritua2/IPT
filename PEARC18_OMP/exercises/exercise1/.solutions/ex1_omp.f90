...
!***  Stencil update
!***  This is the OpenMP parallel version
...
!***  Compile with: ifort -xhost -qopenmp ex1_omp.f90
...
!$omp parallel do default(none) shared(n, x, y) private(i, j, tmp) reduction (+: sum)
        do j=2, n-1
          do i=2, n-1
